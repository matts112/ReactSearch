    ...
    return (
      <div>
        <Grid container spacing={24} alignItems="stretch" alignContent="stretch">
          {!bookList.length ? (<Typography variant='h4'> Error! No books with that name!</Typography>) : (
            bookList.map(book => {
              return (
                    ...
                    <div className={classes.details}>
                      ...
                      <CardContent className={classes.content}>
                        ...
                        <CardActions className={classes.actions}>
                          ...
                          <Button size='small' color='secondary' onClick={() => this.deleteBook(book._id)}>Delete</Button>
                        </CardActions>
                      </CardContent>
                    </div>
                    <CardMedia
